...
class Student extends Model
{
    ...
    public static function viewForDocumentStudent($request)
    {
        try {
            ...
            $student_enrollmentsOn = DB::table('viewEnrollments')->select('stu_enr_id','pha_name','stu_id','stu_enr_status','peri_name','stu_enr_semester','stu_enr_journey','pro_name','car_name','stu_enr_date','car_name','car_id','peri_id','pha_id','peri_start','peri_end','car_typ_id','car_typ_name')->where('stu_enr_status', '=', 1)->where('stu_id','=',$student[0]->stu_id)->get();

            $student_enrollmentsOff = DB::table('viewEnrollments')->select('stu_enr_id','pha_name','stu_id','stu_enr_status','peri_name','stu_enr_semester','stu_enr_journey','pro_name','car_name','stu_enr_date','car_name','car_id','peri_id','pha_id','peri_start','peri_end','car_typ_id','car_typ_name')->where('stu_enr_status', '=', 0)->where('stu_id','=',$student[0]->stu_id)->get();
