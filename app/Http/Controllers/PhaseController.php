...
class PhaseController extends Controller
{
    ...
    public function store(Request $request,$proj_id, $use_id)
    {
            ...
            if ($validator->fails()) {
                ...
                $phases->save();
                Controller::NewRegisterTrigger("Se realizo una inserción en la tabla phases",3,$proj_id,$use_id);
                return response()->json([
                    'status' => true,
    ...
    public function show($proj_id, $use_id, $phase)
    {
    ...
    public function update(Request $request, $proj_id, $use_id, $phase)
    {
            ...
            if ($validator->fails()) {
                ...
                $phases->pha_phase=$request->pha_phase;
                $phases->save();
                Controller::NewRegisterTrigger("Se realizo una edición en la tabla phases",1,$proj_id,$use_id);
                return response()->json([
                    'status' => true,
